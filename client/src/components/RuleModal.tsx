...
const rules:Record<GameType,string[]>={
 ...
 ASCENDING:["매 턴 1~10 카드 두 장이 공개되고, 선택권을 가진 플레이어가 한 장을 가져갑니다.","남은 카드는 상대에게 자동 지급되며, 양쪽은 받은 카드를 비공개로 빈칸에 배치합니다.","상대의 보드와 배치 위치는 10턴이 모두 끝날 때까지 공개되지 않습니다.","종료 후 가장 긴 인접 비내림차순(왼쪽 ≤ 오른쪽)을 비교합니다. 같은 숫자도 연결됩니다."],
